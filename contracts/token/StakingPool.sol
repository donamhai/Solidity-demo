...
// contract StakingPool is Initializable, UUPSUpgradeable, AccessControlUpgradeable, PausableUpgradeable {
...
//     require(totalShares == 0 && stkToken.balanceOf(address(this)) == 0, 'Stakes and shares are non-zero');
...
//     require(stkToken.transferFrom(msg.sender, address(this), stakeAmount), 'STK transfer failed');
...
//       require(
//         stkToken.transfer(stakeholders.at(s), stakeholderToStake[stakeholders.at(s)].stakedSTK),
//         'STK transfer failed'
//       );
